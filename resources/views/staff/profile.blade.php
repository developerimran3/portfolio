                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Student Profilep</li>
                        </ol>
                    </nav>
                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        ...
                                        <div class="mt-3">
                                            <h4>{{ Auth::guard('student')->user()->firstName }}
                                                {{ Auth::guard('student')->user()->lastName }}
                                            </h4>
                                            <p class="text-secondary mb-1">Email:
                                                {{ Auth::guard('student')->user()->email }}
                                            </p>
                                            <p class="text-secondary mb-1">Skill:
                                                {{ Auth::guard('student')->user()->skill }}</p>

                                            <p class="text-muted font-size-sm">Address:
                                ...
                                <div class="card-body">
                                    <form action="">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input type="text" class="form-control"
                                                    value="{{ Auth::guard('student')->user()->skill }}" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-sm-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                ...
                                                @if (Auth::guard('student')->user()->photo)
                                                    <img src="{{ URL::to('media/student/' . Auth::guard('student')->user()->photo) }}"
                                                        alt="Current Photo" class="mt-2" width="100" />
                                                @endif
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input type="submit" class="btn btn-primary px-4" value="Student Update" />
                                            </div>
                                        </div>
                                    </form>
                                </div>
