                        ...
                        <div class="card-body">
                            <div class="p-4 rounded">
                                <div class="text-center">
                                    ...
                                    <p>Don't have an account yet? <a href="{{ route('teacher.register') }}">Teacher Sign up
                                            here</a>
                                    </p>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="form-body">
                                    <form class="row g-3" action="{{ route('teacher.login') }}" method="POST">
                                        @csrf
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button type="submit" class="btn btn-primary"><i
                                                        class="bx bxs-lock-open"></i>teacher Login</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
